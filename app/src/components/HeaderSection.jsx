  ...
  return <header className="hero">
    <div className="hero-grid">
      <div className="hero-copy">
        ...
        <div className="hero-socials"><a href="https://github.com/BrookMulu" target="_blank" rel="noreferrer">GitHub ↗</a><a href="https://linkedin.com/in/brook-gebreeyesus" target="_blank" rel="noreferrer">LinkedIn ↗</a><span>Always learning. Always building.</span></div>
      </div>
